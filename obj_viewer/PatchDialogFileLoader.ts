...
let handleFileSelect = (evt:Event, loader, instance?, onLoad?, onProgress?, onError?) => {
...
export let requestFileFromLocal = (url, loadFunc, instance, onLoad, onProgress, onError) => {
...
export let patchLoader = (loader,
                         checkWhiteList?:(url:string) => boolean,
                         loadHandler?:(url:string, originLoad, instance, onLoad, onProgress, onError) => void
) => {
    let oldLoadFunc = loader.prototype.load;
